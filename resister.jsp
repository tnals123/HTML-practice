...
<body class = "body">
    <main class="resistersection">
        <form method="post" name="resister">
            ...
            <p class="idpw_section">
                <input type="password" class="idpw" placeholder="비밀번호를 확인하세요">
            </p>
            <p class="idpw_section">
                <input type="text" class="idpw" placeholder="이름을 입력하세요">
            </p>
            <p class="idpw_section">
                <input type="text" class="idpw" placeholder="연락처를 입력하세요">
            </p>
